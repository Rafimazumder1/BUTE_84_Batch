...
$sql = "SELECT *
FROM NAA_MEMBERS WHERE STATUS = 'P'";
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3" style="background-color: #69bbf0;">
                            ...
                            <h4 class=" text-center m-4" style="color: white; font-weight: bold;">Pending Member List</h4>
                                    ...
                                    <tbody>
                                        ...
                                        <tr style="color: black!important;">
                                                ...
                                                <td style="text-align: center;">
                                                    ...
                                                    <!-- Edit button -->
                                                    <a href="pending_member_ap.php?id=<?php echo $user_row[$i]['MEM_ID'] ?>" class="btn btn-info btn-sm" >
                                                                Approve</i>
                                                             </a>
