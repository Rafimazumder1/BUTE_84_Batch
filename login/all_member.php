                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3" style="background-color: #69bbf0;">
                            ...
                            <h4 class=" text-center m-4" style="color: white; font-weight: bold;">IET Officer’s Kallyan Forum Dhaka</h4>
                            <h4 class=" text-center m-4" style="color: white; font-weight: bold;">All Member List</h4>
                                ...
                                <table class="table table-bordered" id="table_id" width="100%" cellspacing="0">
                                    <thead style="color: #212121;">
                                        <tr>
                                            ...
                                            <th style="text-align: center;"> Work Place</th>
                                    ...
                                    <tbody>
                                        ...
                                        <tr style="color: black!important;">
                                                ...
                                                <td style="text-align: center;">
                                                    ...
                                                    <?php echo $user_row[$i]['M_NAME'] ?>

                                                </td>

                                                <td style="text-align: center;">

                                                    <?php echo $user_row[$i]['OFFICE_NAME'] ?>
                                                ...
                                                <td style="text-align: center;">
                                                    ...
                                                    <!-- Edit button -->
                                                    <a href="Edit_member.php?id=<?php echo $user_row[$i]['MEM_ID'] ?>" class="btn btn-info btn-sm" >
                                                                Edit</i>
                                                             </a>
