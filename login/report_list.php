...
// Sample SQL query
$sql = "SELECT MEM_ID, MEM_NAME, PROF_NAME, MEM_MOBILE_NO, YR_OF_PASS, PROF_CODE, PAYMENT_STATUS, MEM_PHOTO 
        FROM NAA_MEMBERS_VIEW";
...
<body id="page-top">
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3" style="background-color: #8468F4;;">
                            ...
                            <h4 class=" text-center m-4" style="color: white; font-weight: bold;">100 Years Celebration
                            </h4>
                            <!-- <h6 class=" text-center m-4" style="color: white; font-weight: bold;">Reunion 2025</h6> -->
                                ...
                                <table class="table table-bordered" id="table_id" width="100%" cellspacing="0">
                                    <thead style="color: #212121;">
                                        <tr>
                                            ...
                                            <th style="text-align: center;">Bus Pick up place </th>
                                            <th style="text-align: center;">Event Card Download </th> -->
                                    ...
                                    <tbody>
                                        ...
                                        <tr style="color: black!important;">
                                            ...
                                            <td style="text-align: center;">
                                                ...
                                                <?php echo $user_row[$i]['YR_OF_PASS'] ?>
                                            ...
                                            <td style="text-align: center;">
                                                ...
                                                <?php echo $user_row[$i]['PROF_NAME'] ?>

                                            </td>

                                            <td style="text-align: center;">

                                                <?php echo $user_row[$i]['PAYMENT_STATUS'] ?>
                                            ...
                                            <td style="text-align: center;">
                                                <?php if (!empty($user_row[$i]['MEM_PHOTO'])): ?>
                                                <img src="<?php echo $user_row[$i]['MEM_PHOTO']; ?>" alt="Photo"
                                                    width="60" height="60"
                                            ...
                                            <td style="text-align: center;">
                                                    <a href="http://localhost:8080/iet_school/itbl.php?id=<?php echo ($user_row[$i]['MEM_ID']); ?>" 
 ...
 -->
                                            ...
                                            <!--  <td style="text-align: center;">
                                                    ...
                                                    <?php echo $user_row[$i]['PRESENT_DATE'] ?>

                                                </td> -->

                                            <!-- <td style="text-align: center;">
                                                    <a href="itbl.php?id=<?php echo ($user_row[$i]['MEM_ID']); ?>" 
                                                    class="btn btn-danger btn-sm">
                                                    Download PDF
                                                    </a>
                                                </td>
