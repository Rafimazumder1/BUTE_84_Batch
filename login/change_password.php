...
$sql = "SELECT fngetpass(PASSWORD) as PASSWORD,MEM_ID from NAA_MEMBERS
where MEM_ID = $session_id";
...
if (isset($_POST['submit'])) {
    ...
    if ($old_password != $PASSWORD) {
        ...
        $sql_up = "UPDATE NAA_MEMBERS  SET PASSWORD = '$new_password' WHERE  MEM_ID = '$MEM_ID' ";


        // print_r($sql_up);
        // var_dump($sql);
        $parseresult = ociparse($conn, $sql_up);
        // var_dump($parseresult);
        // ociexecute($parseresult);
        if (ociexecute($parseresult)) {
            // echo "Congratulations You have successfully changed your password";
            echo '<script>alert("Congratulations You have successfully changed your password")
            // window.location.href = "http://103.106.118.10/ndc_alumni_2024/change_password.php";
            </script>';
        } 
    } else {
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3" style="background-color: #69bbf0;">
                            ...
                            <h4 class=" text-center m-4" style="color: white; font-weight: bold;">Change Password</h4>
                                ...
                                <form action="" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="row m-3">
                                        ...
                                        <div class="col-lg-4 col-md-4 col-sm-12">
                                            <div class="row ">
                                                <div class="col-lg-12 col-md-12 col-sm-12">
                                                    <label for="text" class="text-center font-weight-bold">Old Password <label style="color:red; font-weight:bold">*</label> :</label>
                                                </div>
                                                <div class="col-lg-12 col-md-12 col-sm-12">

                                                <input type="text" class="form-control" name="old_password" id="old_password" placeholder="Enter Old Password:" value="">
                                        ...
                                        <div class="col-lg-4 col-md-4 col-sm-12">
                                            <div class="row ">
                                                <div class="col-lg-12 col-md-12 col-sm-12">
                                                    <label for="text" class="text-center font-weight-bold">New Password <label style="color:red; font-weight:bold">*</label> :</label>
                                                </div>
                                                <div class="col-lg-12 col-md-12 col-sm-12">
                                        ...
                                        <div class="col-lg-4 col-md-4 col-sm-12">
                                            <div class="row ">
                                                <div class="col-lg-12 col-md-12 col-sm-12">
                                                    <label for="text" class="text-center font-weight-bold">Confirm New Password <label style="color:red; font-weight:bold">*</label> :</label>
                                                </div>
                                                <div class="col-lg-12 col-md-12 col-sm-12">

                                                <input type="text" class="form-control" name="confirm_new_password" id="confirm_new_password" placeholder="Enter Confirm New Password" value="">
