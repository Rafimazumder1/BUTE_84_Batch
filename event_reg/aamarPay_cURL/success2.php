...
curl_setopt($curl_handle,CURLOPT_URL,"https://secure.aamarpay.com/api/v1/trxcheck/request.php?request_id=$merTxnId&store_id=shaab&signature_key=043f408fbcc1b9cd40c5a6d8ba900050&type=json");
...
$paystatus=$a['pay_status'];
    ...
    :pg_service_charge_USD,:pg_card_bank_name,:pg_card_bank_country,:risk_level,:p_MEM_MOBILE_NO); end;");
//,:p_INVOICE_AMOUNT,:p_OTC_AMOUNT,:P_INV_NO,:p_MEM_ID
        ...
        if ($returnval === 1) {
            ...
            // window.location.href = "https://shaab.iadmissionbd.net/alert.php";
...
<body>
    ...
    <input style="width:70%;" type="text" class="form-control" placeholder="Enter Trx ID" name="mer_txnid" id="mer_txnid" value="<?php if (isset($_POST['mer_txnid'])) echo $_POST['mer_txnid']; ?>" required>
