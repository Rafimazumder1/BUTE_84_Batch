...
// member search database 
/* Data Filter Start */
// if (isset($_POST['submit1'])) {


//     $p_mobile_no = $_POST['mem_mobile'];
...
//     $stid = oci_parse($conn, "begin PKG_member.DPD_BCSWN_members_select(:cur_data,:p_mobile_no); end;");


//     oci_bind_by_name($stid, ":cur_data", $curs, -1, OCI_B_CURSOR);
//     oci_bind_by_name($stid, ":p_mobile_no", $p_mobile_no, -1, SQLT_CHR);
            ...
            <div class="col-xl-12 col-md-12 col-lg-12 col-sm-12">
                ...
                <div class="row" style="background-color: #fff">
                    ...
                    <div class="col-md-8 col-sm-8">
                        <div class="header" >
                            <img src="./uploads/buet.png" style="border: 1px solid #ac1f25;" class="mr-4 " alt="BD Logo">
                            <h2>
                            Bandhan'84, BUET </h2>
                        </div>
                    </div>
                                    ...
                                    <form action="" method="POST" enctype="multipart/form-data">
                                            ...
                                            <div class="col-lg-12 col-md-12 col-sm-12">
                                                <div class="row">
                                                    <div class="col-lg-3 col-md-3 col-sm-12">
                                                        <label for="text" class="text-center font-weight-bold" style="color: #ac1f25">Photograph :</label>ac1f25
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group col-md-6 col-lg-6 col-sm-12 pl-0">
                                                ...
                                                <input style="width:70%;" type="text" class="form-control" placeholder="Enter Name" name="MEM_NAME" id="MEM_NAME" value="<?php echo $report_output[0]['NAME'] ?>" required>
                                            ...
                                            <div class="form-group col-md-6 col-lg-6 col-sm-12  pl-0">
                                                <label class="form-label" for="validationServer03">Mobile <label style="color:red; font-weight:bold">*</label> :</label>
                                                <input style="width:70%;" type="number" pattern="/^-?\d+\.?\d*$/" onKeyPress="if(this.value.length==11) return false;" class="form-control"  name="MEM_MOBILE_NO" id="MEM_MOBILE_NO" value="<?php echo $report_output[0]['MOBILE'] ?>" placeholder="Mobile Number" required>
                                            ...
                                            <!-- Faculty starts  -->
                                            <div class="form-group col-md-6 col-lg-6 col-sm-12 pl-0">
                                                <label class="form-label" for="validationServer03">Faculty <label style="color:red; font-weight:bold">*</label>:</label>
                                            ...
                                            <div class="form-group col-md-6 col-lg-6 col-sm-12  pl-0">
                                                ...
                                                <input style="width:70%;" type="email" class="form-control"  placeholder="Email Address" name="PRE_EMAIL" id="PRE_EMAIL" value="<?php echo $report_output[0]['EMAIL'] ?>" required>
