...
<body>
            ...
            <div class="card" style="background-color: #fff;">
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            <div class="header">
                                <img src="../uploads/Bandhan84.jpeg" alt="logo" width="60px" height="60px"
                                    style="border: 1px solid #F35F73;" />
                        ...
                        <form action="" method="">
                            <div class="row m-3" style="padding-top: 20px;">
                                <div class="col-lg-4 col-md-4 col-sm-12">
                                    <div class="row">
                                        <div class="">
                                            <label for="text" class="font-weight-bold">Membership <label
                                ...
                                <div class="col-lg-8 col-md-8 col-sm-12">
                                    <div class="row">
                                        <div class="col-lg-3 col-md-3 col-sm-12">
                                            <label for="text" class="text-center font-weight-bold">Photograph <label
                                                    style="color:red; font-weight:bold">*</label> :</label>
                                        ...
                                        <div class="col-lg-3 col-md-3 col-sm-12">
                                            <img id="output_image" width="130px" height="130px"
                                                style="border: 1px solid #F35F73;"></img>
                                            <input type="text" class="form-control" name="basedata" id="basedata"
                                                hidden>
                            ...
                            <div class="row m-3">
                                <div class="col-lg-5 col-md-5 col-sm-12">
                                    <div class="row ">
                                        <div class="col-lg-2 col-md-2 col-sm-12">
                                            <label for="text" class="text-center font-weight-bold">Name of Applicant
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-12">
                                    <div class="row">
                                        <div class="col-lg-6 col-md-6 col-sm-12">
                                            <label for="Date" class="text-center font-weight-bold"
 ...
 -->
                    ...
                    <div class="row m-3">
                        <div class="col-lg-6 col-md-6 col-sm-12">
                            <div class="row ">
                                ...
                                <div class="col-lg-10 col-md-10 col-sm-12">
                                    <input type="text" class="form-control" name="F_NAME" id="F_NAME"
                                        placeholder="Enter Spous's Name"
                                        value="<?php if (isset($_POST['F_NAME'])) echo $_POST['F_NAME']; ?>">
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row m-3">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12">
                            <div class="col-lg-8 col-md-8 col-sm-12" style="margin-top: 20px;">
                                <div class="row">
                                    <div class="col-lg-12 col-md-12 col-sm-12">
                                        <label for="text" class="text-center font-weight-bold">Permanent Address
                                            :</label>
                ...
                <div class="col text-center">
                                <button type="submit" class="btn btn-success m-3" name='submit' id='submit' onclick="return Validate()">
                                    Submit
                                </button>
                            </div>
    ...
    $(document).ready(function() {
        $("#Verify").click(function() {
            ...
            if (bla === "") {
                ...
                if (bla === php_var) {
                    document.getElementById('levelcap').innerHTML =
                        'Successfully Verified. Now You Can Update Your Information.';
