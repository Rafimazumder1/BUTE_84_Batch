        ...
        <div class="page-body event-page mb-4">
            ...
            <div id="page-content">
                                ...
                                <ol>
                                  ...
                                  To create bond among the members through technical,social and cultural activities</li>
                                  <li style="margin-top: 8px;">
                                  To Work for the welfare of the members.If necessary extend financial help to needy members and their families</li>
                                  <li style="margin-top: 8px;">
                                    To Work for the continuous improvement and technical development of the members
                                  </li>
                                  <li style="margin-top: 8px;">
                                  To make continuous efforts for national and social advancement of the county </li>
                                  <li style="margin-top: 8px;">
                                  To maitain good relationship with other professional organization in the related field </li>
                                  <li style="margin-top: 8px;">
                                    To co-operate with BUET and BUET Alumni activities for the national interest of the country
                                  </li>
                                </ol> 
